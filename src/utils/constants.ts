...
export const COURSES: Course[] = [
  ...
  },
  {
    ...
    features: [
      'DSA (Data Structures & Algorithms) — From Scratch to Advanced: Master Data Structures & Algorithms from the very basics to advanced interview-level concepts. Learn problem-solving techniques, optimize coding logic, and prepare for top product-based company interviews with structured learning and guided practice.',
      'Advanced Portfolio Building: Build a modern, professional, and recruiter-attractive portfolio showcasing your projects, skills, and achievements to stand out in placements and job applications.',
      'Advanced Resume + ATS Optimization: Get a professionally designed ATS-friendly resume optimized to increase your chances of getting shortlisted by recruiters and companies.',
      'LinkedIn Profile Optimization: Create a powerful LinkedIn presence with expert guidance to improve profile visibility, recruiter engagement, and networking opportunities.',
      'Multiple Mock Interviews with Experts: Participate in multiple technical and HR mock interviews conducted by experienced mentors and industry professionals with detailed feedback sessions.',
      'LeetCode Practice & Coding Preparation: Strengthen your coding skills with regular LeetCode practice sessions, company-specific questions, and guided problem-solving strategies.',
      'Tests & Assignments: Track your growth through structured tests, coding assignments, practical tasks, and performance evaluations designed to improve your learning consistently.',
      'WhatsApp Job Alerts: Receive instant job updates, hiring opportunities, internships, off-campus drives, and placement notifications directly on WhatsApp.',
      'System Design Fundamentals: Learn system design concepts including scalable architecture, databases, APIs, backend flow, and real-world application structure preparation for advanced interviews.',
      'One Tech Stack (As Per Your Choice): Choose your preferred technology stack and receive focused training based on your career goals and interests.',
      'Communication & Soft Skills Training: Improve communication, confidence, professional speaking, and interview interaction skills essential for placement success.',
      'Advanced Real-World Projects: Work on industry-level projects to gain practical experience and build strong portfolio-ready applications.',
      'Complete Interview Training: Prepare for technical interviews, HR rounds, aptitude discussions, behavioral questions, and company-specific interview patterns.',
      'Career Counseling & Guidance: Get personalized career guidance, roadmap planning, and mentorship to help you make better career decisions and achieve your placement goals.',
      'Lifetime Access: Get lifetime access to recorded sessions, learning materials, future updates, practice resources, and community support.',
    ],
